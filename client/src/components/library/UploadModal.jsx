...
export default function UploadModal({ subjects, onClose, onUploaded }) {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {file ? (
              <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <button type="button" onClick={() => setFile(null)} className="text-red-500 hover:text-red-700 font-bold text-lg leading-none">&times;</button>
              </div>
            ) : (
          ...
          <div className="flex gap-2 pt-1">
            <button type="submit" disabled={uploading} className="btn-primary flex-1 py-2">{uploading ? 'Uploading...' : 'Upload'}</button>
