...
import PrintRequestHistoryList from '../../components/profile/PrintRequestHistoryList';
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      <div className="flex items-center justify-between">
        <Link to="/secretary/teachers" className="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1">← Back</Link>
        <Button onClick={() => setShowMessageModal(true)}>✉️ Send Message</Button>
      </div>
      <TeacherProfileCard profile={profile} />
      <PrintRequestHistoryList requests={requests} />
